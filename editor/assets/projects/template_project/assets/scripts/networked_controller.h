...
RF_CLASS(Category = "Gameplay", DisplayName = "Networked Controller")
class CODEX_EXPORT NetworkedController : public NativeBehaviour, public Loggable<"NetworkedController">
{
    RF_SERIALIZABLE
