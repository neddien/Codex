...
namespace codex::editor {
    ...
    void Editor::on_attach()
    {
        ...
        gfx::BatchRenderer2D::init(EditorApplication::get_app_data_path() / "GL Shaders/BatchRenderer2D_Quad.glsl");
        gfx::DebugDraw::init(EditorApplication::get_app_data_path() / "GL Shaders/DebugDraw_Line2D.glsl");
