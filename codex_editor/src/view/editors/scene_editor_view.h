...
namespace codex::editor {
    ...
    public:
        ...
        void visualize_colliders() const noexcept;
    ...
    public:
        ...
        static void draw_vec3_control(const char* label, Vector3f& values, const f32 columnWidth = 100.0f,
                                      const f32 speed = 1.0f, const f32 resetValue = 0.0f);
        static void draw_vec2_control(const char* label, Vector2f& values, const f32 columnWidth = 100.0,
