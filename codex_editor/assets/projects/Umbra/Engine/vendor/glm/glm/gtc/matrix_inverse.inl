...
namespace glm {
    ...
    GLM_FUNC_QUALIFIER mat<3, 3, T, Q> affineInverse(mat<3, 3, T, Q> const& m)
    {
        ...
        return mat<3, 3, T, Q>(vec<3, T, Q>(Inv[0], static_cast<T>(0)), vec<3, T, Q>(Inv[1], static_cast<T>(0)),
    ...
    GLM_FUNC_QUALIFIER mat<4, 4, T, Q> affineInverse(mat<4, 4, T, Q> const& m)
    {
        ...
        return mat<4, 4, T, Q>(vec<4, T, Q>(Inv[0], static_cast<T>(0)), vec<4, T, Q>(Inv[1], static_cast<T>(0)),
