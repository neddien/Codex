...
namespace glm {
    ...
    GLM_FUNC_QUALIFIER mat<4, 4, T, Q> rotateNormalizedAxis(mat<4, 4, T, Q> const& m, T const& angle,
                                                            vec<3, T, Q> const& v)
    {
        T const a = angle;
        T const c = cos(a);
    ...
    GLM_FUNC_QUALIFIER qua<T, Q> rotateNormalizedAxis(qua<T, Q> const& q, T const& angle, vec<3, T, Q> const& v)
    {
        ...
        // return gtc::quaternion::cross(q, tquat<T, Q>(cos(AngleRad * T(0.5)), Tmp.x * fSin, Tmp.y * fSin, Tmp.z *
        // fSin));
    }
} // namespace glm
