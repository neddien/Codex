...
namespace glm {
    namespace detail {
        ...
        {
            GLM_FUNC_QUALIFIER static vec<L, T, Q> call(vec<L, T, Q> const& N, vec<L, T, Q> const& I,
    ...
    /*
        ...
        {
            GLM_STATIC_ASSERT(std::numeric_limits<genType>::is_iec559, "'normalize' accepts only floating-point
       inputs");
