...
namespace codex::util {
    ...
    namespace crypto {
        ...
        [[nodiscard]] inline u32 crc32_update(const void* data, const usize size,
                                              const u32 crc = 0xFFFFFFFFu) noexcept
        {
            u32        running = crc;
        ...
        [[nodiscard]] inline u32 crc32_finalize(const u32 running) noexcept { return running ^ 0xFFFFFFFFu; }
