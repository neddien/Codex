...
namespace codex::fs {
    ...
    public:
        ...
        [[nodiscard]] Shared<FileHandle> open(const std::string& path, const FileProperties props = {}) noexcept;
        ...
        [[nodiscard]] cc::Task<Shared<FileHandle>>  open_async(std::string    path,
